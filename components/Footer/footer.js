      ...
      <div className='bg-dark h-80 flex items-end px-20 py-8 z-0'>
        ...
        <div className='px-16 pb-3'>
          ...
          <div className='flex mt-4'>
            <input type="email" name="email" id="news-letter-email" className='w-full bg-gray-100 rounded border border-gray-300 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out' />
