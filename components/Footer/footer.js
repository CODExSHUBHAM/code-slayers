...
const Footer = () => {
  return (
    <>
      <div className='flex items-center justify-between h-40 bg-blue-100 w-3/5 mx-auto rounded-2xl z-100 -mb-16 -mt-28 relative p-10 drop-shadow-2xl shadow-black'>
        <div>
      ...
      <div className='bg-dark h-96 flex flex-col justify-center items-center  px-20 pt-16 z-0'>
        ...
        <div className='py-2 text-white flex'>
          ...
          <h2 className='text-secondary px-1'>CODExSHUBHAM</h2>
        </div>
      </div>
    </>
  )
